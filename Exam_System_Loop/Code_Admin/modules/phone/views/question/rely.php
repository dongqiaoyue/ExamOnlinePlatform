        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><a style="cursor:pointer;" href="<?=Url::toRoute("question/index")?>">学生问答管理-></a>
                        <a style="cursor:pointer;" href="<?=Url::toRoute("question/view").'&ID='.$_GET['rid']?>"><?=$tre->Resources($_GET['rid'])?>-></a>查看情况</h3>
                </div>
                <h1></h1>
                <br>
                <div class="row">
