...
class PptController extends BaseController
{
    ...
    public function actionCreate()
    {
        ...
        if ($m_ppt->load($post)) {
            ...
            shell_exec('java -jar /usr/local/jodconverter-2.2.2/lib/jodconverter-cli-2.2.2.jar '.Yii::$app->basePath.'/web/uploads/ppt/'.$name.' /var/www/html/break/web/'.$real_name.'.pdf');
