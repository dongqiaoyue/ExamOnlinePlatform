                            ...
                            <div class="col-sm-12">
                                <table id="data_table" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="data_table_info">
                                    ...
                                    foreach ($info as $model) {
                                        ...
                                        echo '      <a id="edit_btn" onclick="editConfAction(' . "'$model->ExamConfigRecordID'"  . ')" class="btn btn-primary btn-sm" href="#"> <i class="glyphicon glyphicon-edit icon-white"></i>编辑</a>';
...
<script>
    ...
    function editConfAction(id){
        // $("#editName_ExamConfigRecordID").val(id);
        // $('#editName_dialog').modal('show');
        window.location.href = '<?=Url::toRoute("exam-module/update-view")?>'+'&id='+id;
    }
