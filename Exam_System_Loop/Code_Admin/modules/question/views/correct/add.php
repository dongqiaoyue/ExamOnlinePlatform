        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">改错题管理->改错题添加</h3>
                </div>
                <h1></h1>
                <div class="box-body">
                    <?php $form = ActiveForm::begin(["id" => "admin-role-form", "class"=>"form-horizontal", "action"=>Url::toRoute("correct/index")]); ?>
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox1" value="1" name="Answer[]"> 1
                                </label>
                                <label class="checkbox-inline">
                                    <input type="checkbox" id="inlineCheckbox2" value="0" name="Answer[]"> 0
                                </label>
...
<script type="text/javascript">
    ...
    $('#admin-role-form').bind('submit',function (e) {
        ...
        $(this).ajaxSubmit({
            type:'POST',
            dataType:'json',
            url:'<?=Url::toRoute("correct/create")?>',
            success:function (value) {
                if(value.error == 0){
                    alert('添加成功');
                    window.location.href = '<?=Url::toRoute("correct/index")?>'
                }else{
                    alert('添加失败');
                }
            }
