                    ...
                    <div id="des_div" class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" class="checkboxs" id="inlineCheckboxA" value="A" name="Questions[Answer]"> A
                            </label>
                            <label class="radio-inline">
                                <input type="radio" class="checkboxs" id="inlineCheckboxB" value="B" name="Questions[Answer]"> B
                            </label>
                            <label class="radio-inline">
                                <input type="radio" class="checkboxs" id="inlineCheckboxC" value="C" name="Questions[Answer]"> C
                            </label>
                            <label class="radio-inline">
                                <input type="radio" class="checkboxs" id="inlineCheckboxD" value="D" name="Questions[Answer]"> D
                            </label>
...
<?php $this->beginBlock('footer');  ?>
    ...
    $('#stage-choice').change(function () {
        ...
        var url = '<?=Url::toRoute('choice/index')?>';
    ...
    $('#knowledgepoint-choice').change(function () {
        ...
        function initEditSystemModule(data, type){
            if(type == 'create'){
                ...
                $('#inlineCheckbox'+data['Answer']).attr('checked',true);
